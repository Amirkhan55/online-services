...
const ResumeCard = (props) => {
  return (
    <div
      className="group flex  max-w-[601px] pl-[31px] border-l-4 border-[#17191c] max-h-[296px] w-full h-full gap-2  py-6 bg-[#222428] text-left
    w-full h-full transition-all duration-300 ease-in-out hover:transform hover:-translate-y-2 hover:bg-gradient-to-r hover:from-[#111111] hover:to-[#222428]"
    >
      <hr />
