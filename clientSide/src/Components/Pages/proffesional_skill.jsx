...
const SkillCard = ({ title, skills }) => (
  <div className="bg-[#222428]  text-left rounded-lg max-w-[612px] w-full p-4">
...
const ProfessionalSkillComponent = () => {
  ...
  return (
    <div className="min-h-screen bg-[#222428] max-w-[1330px] w-full h-full flex  justify-center ">
