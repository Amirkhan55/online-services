...
const We_are = () => {
  return (
    <div className="flex flex-col justify-center items-center text-center pt-[400px]">
      <h1 className="text-[50px] py-[20px] text-navyBlue tracking-widest leading-[60px]">
        Who we are
      </h1>
      <p className="text-[20px] py-[20px] text-navyBlue tracking-widest leading-[30px]">
      ...
      <div className="flex justify-center gap-8 items-center text-center w-[80%]">
        <div className="px-[20px] w-1/2 border-l-[6px] border-r-[6px] border-solid border-blue-500 rounded-md">
          <p className="text-[22px] w-[90%] text-left px-[20px] py-5 text-navyBlue tracking-widest leading-[30px]">
